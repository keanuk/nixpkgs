  ...
  patches = [
    ...
    (fetchpatch {
      ...
      sha256 = "FkVyhsM0mRUzZmS2Gh172oqwcfXv6PyD6IEgjBhy2uU=";
		...
		(fetchpatch {
        url = "https://gitlab.gnome.org/chergert/ptyxis/-/raw/main/build-aux/0001-add-notification-and-shell-precmd-preexec.patch";
        hash = "sha256-i53u0q8YXP9qqGdhGeTYrnlLqe1zlpBUXE66zchDz48=";
    })
  ];
